  ...
  return (
    ...
    >
      <div className="prediction-hero">
        <div className="prediction-hero-text">
          ...
          <p>
            ...
            your risk in real time. Whether you're in a wildfire-prone forest or
            a seismically active city, knowing your probability can help you
            take smarter precautions.
          </p>
        </div>
        <div className="prediction-hero-image">
          <img
            src="https://picsum.photos/id/1025/600/400"
            alt="World Risk Map Placeholder"
          />
        </div>
      </div>
      ...
      <p className="prediction-intro">
        Every area has its own seismic signature and wildfire seasonality. Enter
        any city below and our AI will calculate your probability of a major
        earthquake or wildfire over the coming days.
      </p>
